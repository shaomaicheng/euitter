...
import 'package:eui/refresh/internals/indicator_config.dart';
import 'package:eui/refresh/internals/indicator_wrap.dart';
import 'package:eui/refresh/internals/refresh_physics.dart';
...
class _SmartRefresherState extends State<SmartRefresher> {
  ...
  _top() {
    return !widget.enablePullDown || widget.headerConfig is LoadConfig
        ? 0.0
        : -_headerHeight;
  }
  _bottom() {
    return !widget.enablePullUp || widget.footerConfig is LoadConfig
        ? 0.0
        : -_footerHeight;
  }
}
